...
Security fixes are applied to the latest released version of **orchestrail**.
...
[private vulnerability reporting](https://github.com/ZelAnton/orchestrail/security/advisories/new)
